...
static const oe_ecall_info_t _fosdsc_ecall_info_table[] = 
{
    { "enclave_init" },
    { "nonLinearLayer" },
    { "close_encryptor" },
...
oe_result_t fosdsc_enclave_init(
    ...
    size_t context_len)
{
    ...
    /* Marshalling struct. */
    enclave_init_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.hecontext = (uint8_t*)hecontext;
    _args.context_len = context_len;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_init_args_t));
    if (hecontext)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.context_len, sizeof(uint8_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_init_args_t));
    ...
    _pargs_in = (enclave_init_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (hecontext)
        OE_WRITE_IN_PARAM(hecontext, _args.context_len, sizeof(uint8_t), uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fosdsc_ecall_info_table[fosdsc_fcn_id_enclave_init].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (enclave_init_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(fosdsc_enclave_init, enclave_init);

oe_result_t fosdsc_nonLinearLayer(
    oe_enclave_t* enclave,
    int* _retval,
    uint8_t* ectxt,
    size_t ectxt_len,
    ...
    size_t* octxt_len)
{
    ...
    /* Marshalling struct. */
    nonLinearLayer_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.ectxt = (uint8_t*)ectxt;
    _args.ectxt_len = ectxt_len;
    _args.num_ectxt = num_ectxt;
    _args.octxt = (uint8_t**)octxt;
    _args.octxt_len = (size_t*)octxt_len;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(nonLinearLayer_args_t));
    if (ectxt)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.ectxt_len, sizeof(uint8_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(nonLinearLayer_args_t));
    if (octxt)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (nonLinearLayer_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (ectxt)
        OE_WRITE_IN_PARAM(ectxt, _args.ectxt_len, sizeof(uint8_t), uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fosdsc_ecall_info_table[fosdsc_fcn_id_nonLinearLayer].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (nonLinearLayer_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(octxt, 1, sizeof(uint8_t*));
    OE_READ_OUT_PARAM(octxt_len, 1, sizeof(size_t));
...
OE_WEAK_ALIAS(fosdsc_nonLinearLayer, nonLinearLayer);

oe_result_t fosdsc_close_encryptor(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fosdsc_ecall_info_table[fosdsc_fcn_id_close_encryptor].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fosdsc_close_encryptor, close_encryptor);

oe_result_t fosdsc_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fosdsc_ecall_info_table[fosdsc_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fosdsc_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t fosdsc_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fosdsc_ecall_info_table[fosdsc_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fosdsc_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t fosdsc_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fosdsc_ecall_info_table[fosdsc_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fosdsc_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t fosdsc_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fosdsc_ecall_info_table[fosdsc_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fosdsc_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t fosdsc_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fosdsc_ecall_info_table[fosdsc_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fosdsc_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t _fosdsc_ocall_function_table[] = {
...
oe_result_t oe_create_fosdsc_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _fosdsc_ocall_function_table,
               83,
               _fosdsc_ecall_info_table,
                8,
               enclave);
}
