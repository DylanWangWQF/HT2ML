...
void CropImages(vector<vector<float>>& test_imgs, vector<unsigned char>& test_lbls, Mat<RR>*& feaMat, int MNIST_HEIGHT, int MNIST_WIDTH, int num_imgs, int kernel_size, int stride, int window_size)
{
    ...
    string datasets_dir = "/home/dylan/code/HETEE/CNN_benchmark/CompareToOblivious/ObliviousHETEE/scripts";
...
void LoadModel(Mat<RR>*& kernel_weights, Mat<RR>*& dense1_weights, int& kernel_dim1, int& kernel_dim2, int& dense1_dim1, int& dense1_dim2, int num_imgs)
{
    ...
    string datafile1 = "/home/dylan/code/HETEE/CNN_benchmark/CompareToOblivious/ObliviousHETEE/host/model/kernels_weights.dat";
    string datafile2 = "/home/dylan/code/HETEE/CNN_benchmark/CompareToOblivious/ObliviousHETEE/host/model/dense1_weights.dat";
